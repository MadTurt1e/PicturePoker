...
class PlayerDiffblueTest {
    ...
    /**
     * Method under test: {@link Player#resetPerGameInfo()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testResetPerGameInfo() {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        //   java.lang.NullPointerException: Cannot load from object array because "this.hand" is null
        //       at game.jdbc.picturepoker.Player.resetPerGameInfo(Player.java:279)
        //   See https://diff.blue/R013 to resolve this issue.

        // Arrange and Act
        (new Player()).resetPerGameInfo();
    }

    /**
     * Method under test: {@link Player#redrawHand()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testRedrawHand() {
        ...
        //   test threw
        //   java.lang.NullPointerException: Cannot load from object array because "this.hand" is null
        //       at game.jdbc.picturepoker.Player.redrawHand(Player.java:286)
        //   See https://diff.blue/R013 to resolve this issue.

        // Arrange and Act
        (new Player()).redrawHand();
    }
